 ...
 * {@link net.sf.mmm.http.api.HttpRequest} and {@link net.sf.mmm.http.api.HttpResponse}.
 *
 * <pre>
 * {@link net.sf.mmm.util.http.api.HttpRequestBuilder} builder = new {@link net.sf.mmm.util.http.api.HttpRequestBuilder}();
 * {@link net.sf.mmm.http.api.HttpRequest} request = builder.{@link net.sf.mmm.util.http.api.HttpRequestBuilder#doGet(String)
 ...
 * {@link net.sf.mmm.http.api.HttpRequest} or the filename of an uploaded or downloaded file you need to fiddle
 ...
 * information without any string fiddling. See {@link net.sf.mmm.http.api.header HTTP API header documentation}
 ...
 * dedicated {@link net.sf.mmm.http.api.ssdp API and implementation}.</li>
 * </ul>
 */
package net.sf.mmm.http.api;
